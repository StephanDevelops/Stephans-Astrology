      ...
      <div class="swiper home-slide">
        <div class="swiper-wrapper">
          ...
          <!-- <div class="swiper-slide box">
                    ...
                    <div class="content">
                        <h3>Want to know how the universe effects you personally?</h3>
                        <p>Let us help you by bringing together all the information we provide and going deeper through a birth chart reading</p>
                        <a href="#services" class="btn">Learn more</a>
                    </div>          
                </div> -->
        </div>
